...
\date{March 2026\\[2pt]
\small \textsc{doi}: \href{https://doi.org/10.5281/zenodo.19268994}{10.5281/zenodo.19268994}}
...
Hypothesis; see~\cite{alarcon2026d} for the structural scope of
this connection and its limitations.
...
The structural limitations of this connection---specifically,
which spacing-based functionals can and cannot detect off-line
zeros---are analysed in~\cite{alarcon2026d}.
The present paper focuses on the Fourier-analytic result
(Theorem~\ref{thm:main}), which is of independent interest.
